...
public class ThirdPersonCamera : MonoBehaviour
{
    ...
    public float distance = 5.0f; // Distancia desde la cámara al objetivo
    public float height = 2.0f; // Altura de la cámara con respecto al objetivo
    public float rotationSpeed = 100.0f; // Velocidad de rotación de la cámara con el clic derecho
    public float zoomSpeed = 2.0f; // Velocidad de zoom con la rueda del ratón
    public float minDistance = 2.0f; // Distancia mínima al objetivo
