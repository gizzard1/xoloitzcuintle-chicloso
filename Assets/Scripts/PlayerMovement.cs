...
{
    public float moveSpeed = 20f;    // Velocidad de movimiento horizontal
    public float currentSpeed;
    public float jumpForce = 30f;    // Fuerza del salto
    public float gravityScale = 2f; // Factor de gravedad personalizado
    ...
    void Update()
    {
        ...
        // Rotar el jugador para que coincida con la dirección de la cámara
